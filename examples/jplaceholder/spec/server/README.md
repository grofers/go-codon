This directory should contain specification for service side components in hello-codon. The following files/directories further classify the specifications:
